...
<p align="center">
  <img src="https://images.unsplash.com/photo-1516321165247-4aa89a48be28?auto=format&fit=crop&w=1400&q=80" alt="Prevención y concienciación en ciberseguridad" width="100%" />
</p>

<div align="center">

![Unidad](https://img.shields.io/badge/Unidad-UD1-0A84FF?style=for-the-badge)
![Resultado](https://img.shields.io/badge/Resultado-RA1-34D399?style=for-the-badge)
![Nivel](https://img.shields.io/badge/Nivel-Básico%2Fmedio-FFB000?style=for-the-badge)
![Enfoque](https://img.shields.io/badge/Enfoque-Prevención%20y%20concienciación-8B5CF6?style=for-the-badge)
...
- [3. Fundamentos de la prevención en ciberseguridad](#3-fundamentos-de-la-prevención-en-ciberseguridad)
  - [3.1. Qué es la prevención en ciberseguridad](#31-qué-es-la-prevención-en-ciberseguridad)
  - [3.2. Activos, amenazas, vulnerabilidades y riesgos](#32-activos-amenazas-vulnerabilidades-y-riesgos)
  - [3.3. Principios generales de la ciberseguridad](#33-principios-generales-de-la-ciberseguridad)
  - [3.4. Modelo de prevención: desde la política a la conducta](#34-modelo-de-prevención-desde-la-política-a-la-conducta)
  - [3.5. La gestión del riesgo como base de la prevención](#35-la-gestión-del-riesgo-como-base-de-la-prevención)
  - [3.6. Controles preventivos, detectivos y correctivos](#36-controles-preventivos-detectivos-y-correctivos)
  - [3.7. Cultura de seguridad y factor humano](#37-cultura-de-seguridad-y-factor-humano)
  - [3.8. Seguridad como proceso continuo, no como proyecto puntual](#38-seguridad-como-proceso-continuo-no-como-proyecto-puntual)
  - [3.9. Principios generales de la organización en materia de ciberseguridad](#39-principios-generales-de-la-organización-en-materia-de-ciberseguridad)
- [4. Normativa y protección del puesto de trabajo](#4-normativa-y-protección-del-puesto-de-trabajo)
  - [4.1. Importancia de la normativa interna](#41-importancia-de-la-normativa-interna)
  - [4.2. Recomendaciones para la normativa del puesto de trabajo](#42-recomendaciones-para-la-normativa-del-puesto-de-trabajo)
  - [4.3. Ejemplo de política básica de seguridad](#43-ejemplo-de-política-básica-de-seguridad)
  - [4.4. Buenas prácticas de higiene digital en el puesto](#44-buenas-prácticas-de-higiene-digital-en-el-puesto)
  - [4.5. Principios de diseño de una política interna de seguridad](#45-principios-de-diseño-de-una-política-interna-de-seguridad)
  - [4.6. Normas, procedimientos y controles: relación entre ellos](#46-normas-procedimientos-y-controles-relación-entre-ellos)
- [5. Principios de protección del puesto de trabajo](#5-principios-de-protección-del-puesto-de-trabajo)
  - [5.1. Seguridad física y digital del entorno laboral](#51-seguridad-física-y-digital-del-entorno-laboral)
  - [5.2. Recomendaciones prácticas](#52-recomendaciones-prácticas)
  - [5.3. Riesgos habituales en el puesto](#53-riesgos-habituales-en-el-puesto)
- [6. Formación y concienciación en ciberseguridad](#6-formación-y-concienciación-en-ciberseguridad)
  - [6.1. Por qué la concienciación es esencial](#61-por-qué-la-concienciación-es-esencial)
  - [6.2. Objetivos del plan de concienciación](#62-objetivos-del-plan-de-concienciación)
  - [6.3. Públicos objetivo](#63-públicos-objetivo)
  - [6.4. Fases de un plan de concienciación](#64-fases-de-un-plan-de-concienciación)
  - [6.5. Contenidos recomendados para la formación](#65-contenidos-recomendados-para-la-formación)
  - [6.6. Metodología de formación eficaz](#66-metodología-de-formación-eficaz)
  - [6.7. Ejemplo de plan anual de concienciación](#67-ejemplo-de-plan-anual-de-concienciación)
  - [6.8. Diseño y evaluación de una campaña de concienciación](#68-diseño-y-evaluación-de-una-campaña-de-concienciación)
  - [6.9. Principios didácticos para una formación efectiva](#69-principios-didácticos-para-una-formación-efectiva)
  - [6.10. Plan de concienciación dirigido a empleados](#610-plan-de-concienciación-dirigido-a-empleados)
- [7. Materiales de formación y concienciación](#7-materiales-de-formación-y-concienciación)
  - [7.1. Tipos de materiales](#71-tipos-de-materiales)
  - [7.2. Ejemplo de infografía conceptual](#72-ejemplo-de-infografía-conceptual)
  - [7.3. Ejemplo de guía de uso seguro del correo](#73-ejemplo-de-guía-de-uso-seguro-del-correo)
- [8. Auditorías internas de cumplimiento en materia de prevención](#8-auditorías-internas-de-cumplimiento-en-materia-de-prevención)
  - [8.1. Qué es una auditoría interna de cumplimiento](#81-qué-es-una-auditoría-interna-de-cumplimiento)
  - [8.2. Objetivos de la auditoría](#82-objetivos-de-la-auditoría)
  - [8.3. Ámbitos a auditar](#83-ámbitos-a-auditar)
  - [8.4. Ejemplo de matriz de auditoría](#84-ejemplo-de-matriz-de-auditoría)
  - [8.5. Proceso de auditoría](#85-proceso-de-auditoría)
  - [8.6. Hallazgos típicos y medidas correctoras](#86-hallazgos-típicos-y-medidas-correctoras)
  - [8.7. Tipos de auditoría y su utilidad en la prevención](#87-tipos-de-auditoría-y-su-utilidad-en-la-prevención)
  - [8.8. Métricas básicas de cumplimiento](#88-métricas-básicas-de-cumplimiento)
  - [8.9. Auditoría de cumplimiento de planes de concienciación](#89-auditoría-de-cumplimiento-de-planes-de-concienciación)
- [9. Técnicas y procedimientos de prevención comunes](#9-técnicas-y-procedimientos-de-prevención-comunes)
  - [9.1. Seguridad operativa básica](#91-seguridad-operativa-básica)
  - [9.2. Seguridad en entornos compartidos](#92-seguridad-en-entornos-compartidos)
  - [9.3. Seguridad en telecomunicaciones y redes](#93-seguridad-en-telecomunicaciones-y-redes)
  - [9.4. Seguridad de datos sensibles](#94-seguridad-de-datos-sensibles)
- [10. Ejemplos prácticos para el aula](#10-ejemplos-prácticos-para-el-aula)
  - [10.1. Ejemplo de análisis de riesgo sencillo](#101-ejemplo-de-análisis-de-riesgo-sencillo)
  - [10.2. Ejemplo de procedimiento de respuesta frente a un correo sospechoso](#102-ejemplo-de-procedimiento-de-respuesta-frente-a-un-correo-sospechoso)
  - [10.3. Ejemplo de script básico de seguridad en equipo](#103-ejemplo-de-script-básico-de-seguridad-en-equipo)
  - [10.4. Ejemplo de validación de contraseña en Python](#104-ejemplo-de-validación-de-contraseña-en-python)
  - [10.5. Ejemplo de checklist de seguridad para un puesto de trabajo](#105-ejemplo-de-checklist-de-seguridad-para-un-puesto-de-trabajo)
  - [10.6. Mapa de riesgos y controles en un puesto de trabajo](#106-mapa-de-riesgos-y-controles-en-un-puesto-de-trabajo)
  - [10.7. Caso práctico: diseño de un plan de prevención para una pequeña empresa](#107-caso-práctico-diseño-de-un-plan-de-prevención-para-una-pequeña-empresa)
  - [10.8. Roles y responsabilidades en la prevención](#108-roles-y-responsabilidades-en-la-prevención)
  - [10.9. Protocolo de prevención mínima recomendada](#109-protocolo-de-prevención-mínima-recomendada)
- [11. Marco normativo, legal y ético en la prevención](#11-marco-normativo-legal-y-ético-en-la-prevención)
  - [11.1. Relación entre seguridad y cumplimiento](#111-relación-entre-seguridad-y-cumplimiento)
  - [11.2. Normativa y principios relevantes](#112-normativa-y-principios-relevantes)
  - [11.3. Ejemplo de análisis de cumplimiento](#113-ejemplo-de-análisis-de-cumplimiento)
  - [11.4. Qué implica la responsabilidad en ciberseguridad](#114-qué-implica-la-responsabilidad-en-ciberseguridad)
  - [11.5. Relación entre prevención, ética y cumplimiento legal](#115-relación-entre-prevención-ética-y-cumplimiento-legal)
- [12. Planificación de una auditoría interna de cumplimiento](#12-planificación-de-una-auditoría-interna-de-cumplimiento)
  - [12.1. Objetivo](#121-objetivo)
  - [12.2. Fases](#122-fases)
  - [12.3. Lista de verificación de auditoría](#123-lista-de-verificación-de-auditoría)
- [13. Ejercicios de consolidación avanzados](#13-ejercicios-de-consolidación-avanzados)
- [14. Actividades de portfolio o entrega](#14-actividades-de-portfolio-o-entrega)
- [15. Resumen didáctico final de la unidad](#15-resumen-didáctico-final-de-la-unidad)
- [16. Bibliografía recomendada ampliada](#16-bibliografía-recomendada-ampliada)
- [17. Plantillas de entrega para alumnado](#17-plantillas-de-entrega-para-alumnado)
- [18. Autoevaluación final ampliada](#18-autoevaluación-final-ampliada)
...
```mermaid
flowchart LR
A[Políticas y normas] --> B[Controles técnicos] --> C[Formación y concienciación] --> D[Comportamiento seguro] --> E[Reducción del riesgo]
B --> F[Auditoría y mejora continua]
C --> F
D --> F
```
...
```mermaid
flowchart TD
A[Diagnóstico de riesgos y cultura de seguridad] --> B[Definición de objetivos]
B --> C[Diseño de contenidos y canales]
C --> D[Implementación del plan]
D --> E[Seguimiento y evaluación]
E --> F[Mejora continua]
F --> A
```
...
```mermaid
flowchart LR
A[Planificación] --> B[Recopilación de evidencia] --> C[Evaluación y hallazgos]
C --> D[Informe de auditoría] --> E[Acciones correctivas] --> F[Seguimiento]
```
...
```mermaid
flowchart TD
A[Dirección] --> B[Define política y presupuesto]
B --> C[Responsable de seguridad]
C --> D[Usuarios y personal]
C --> E[Administración de sistemas]
C --> F[RRHH]
D --> G[Cumplen normas y reportan riesgos]
E --> H[Controlan equipos, permisos y actualizaciones]
F --> I[Formación, registro y sensibilización]
```
...
sequenceDiagram
    ...
    D->>A: Define alcance y objetivos
    A->>U: Recoge evidencias y revisa procedimientos
    U-->>A: Entrega información y evidencias
    A->>D: Elabora informe con hallazgos
    D->>A: Aprueba plan de mejora
    A->>U: Realiza seguimiento y cierre
```
